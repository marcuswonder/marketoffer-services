...
function renderPage(defaultsJson: string) {
  ...
  '<body>',
  '  <div class="wrap">',
  '    <div class="brand"><a href="/"><img src="https://marketoffer-public-resources.s3.eu-west-2.amazonaws.com/MarketOffer+Icon+-+500px+Width+Inc+Border.png" alt="MarketOffer" /></a></div>',
  '    <div class="topbar">',
