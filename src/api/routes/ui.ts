...
const page = [
  ...
  '    .nav { display:flex; gap:10px; justify-content:center; padding:16px 12px; background:rgba(9,15,29,0.6); border-bottom:1px solid var(--border); position:sticky; top:0; z-index:10; }',
